/* propertyData.js — the data layer for the transaction explorer.
   ───────────────────────────────────────────────────────────────────
...
const TYPE_W = PROPERTY_TYPES_ALL.map(t => ({ t, w: TYPE_META[t].w }));
...
// ---- hierarchy queries -------------------------------------------------
export function getMukims(state, district) {
...
export function getAreas(state, district, mukim) {
...
export function getDistrictAreas(state, district) {
  return districtAreaIndex(state, district).areas;
}
export function getAreaMukim(state, district, area) {
  return districtAreaIndex(state, district).areaToMukim[area] || null;
}
export function getRoads(state, district, mukim, area) {
...
export function getDistrictRoads(state, district) {
  return districtRoadIndex(state, district).roads;
}
export function getRoadPath(state, district, road) {
...
export function getTransactions(path) {
...
export function getTransactionsForScope(path) {
  const { state, district, mukim, area, road } = path || {};
