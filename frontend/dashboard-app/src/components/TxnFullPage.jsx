/* TxnFullPage.jsx — maximized transaction / valuation workspace */
import { C, Eyebrow, Display, Mono, PrimitiveCard as Card } from '@/components/shared/primitives'
import Combobox from '@/components/Combobox'
import ValuationDashboard from '@/components/ValuationDashboard'
import TxnTable from '@/components/TxnTable'
import { formatRM, PROPERTY_TYPES_ALL } from '@/lib/propertyData'
          ...
          <Card style={{ padding: 0, overflow: 'hidden' }}>
            {p.searched
              ? <ValuationDashboard sel={p.searched} loading={load.t} fullpage onExportRoi={p.onExportRoi}
                  onSwitchToMalaysia={p.onSwitchToMalaysia}/>
